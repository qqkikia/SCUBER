    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                String url = getUrl(new LatLng(curLat,curLng),destinationLocation);
...
public void RequestRide(View v){
    ...
    public void UpdateMap(LatLng loc1, LatLng loc2){
        mMap.clear();
        markers.clear();
        Marker marker1 = mMap.addMarker(new MarkerOptions().position(loc1).title("Current Location"));
        markers.add(0,marker1);
        Marker marker2 = mMap.addMarker(new MarkerOptions().position(loc2).title("Current Location"));
